...
def load_brpc():
    ...
    #    name = "openssl",
    #    path = "/opt/conda",
    #    build_file = "//third_party/bazel:openssl.BUILD",
    #)
    http_archive(
    ...
    http_archive(
        ...
        build_file = "//third_party/bazel:protobuf.BUILD",
        patch_cmds = [
    ...
    http_archive(
        ...
        build_file = "//third_party/bazel:crc32c.BUILD",
    ...
    http_archive(
        ...
        build_file = "//third_party/bazel/leveldb:leveldb.BUILD",
    ...
    http_archive(
        ...
        build_file = "//third_party/bazel:snappy.BUILD",
    ...
    http_archive(
        ...
        patch_args = ["-p1"],
        patches = [
            "//third_party/bazel/glog/0001-mark-override-resolve-warning.patch",
        ],
    ...
    http_archive(
        ...
        build_file = "//third_party/bazel:libevent.BUILD",
    ...
    http_archive(
        ...
        build_file = "//third_party/bazel:thrift.BUILD",
    ...
    http_archive(
        ...
        url = "https://github.com/apache/brpc/archive/refs/tags/1.7.0.tar.gz"
    )
